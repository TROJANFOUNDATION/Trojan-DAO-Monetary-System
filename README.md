...
Furthermore, the method described can be forked and the depolyment parameters such as % DAO tax and Bonding Curve parameters adapted to scenarios such as creating a fundraising mechanism for Moloch-fork DAOs, or Moloch-Continuous Organizations, and can also be used to develop other novel crypto-economic experiments and use-cases.
